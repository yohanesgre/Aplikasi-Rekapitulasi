...
namespace Project_Rekap_Pasien
{
    public partial class GJBUserControl : UserControl
    {
        ...
        void chartLoad()
        {
            ...
            chart.AxisX.Minimum = -20;
            chart.AxisY.Minimum = 0;

            chart.AxisX.Maximum = 20;
            chart.AxisY.Maximum = 20;

            chart.AxisY.ScaleView.Zoom(-20, 20);
        ...
        void createChart(string bulan, double BORX, double BORY, double BTOXY, int periode)
        {
            ...
            BTO.BorderWidth = 2;
            BTO.Points.AddXY(0, calculateBTOXY(31, BTOXY));
            BTO.Points.AddXY(calculateBTOXY(31, BTOXY), 0);
        ...
        private void addTahunInComboBox()
        {
        ...
        private void cbTahun_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Console.WriteLine(tahunSelected);
        }
        ...
        private void cbPeriode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (index)
            {
                ...
                case 2:
                    ...
                    initChart();
                    createChart("Maret", indikatorALOS.Maret, indikatorBOR.Maret, indikatorBTO.Maret, 28);
                    break;
                case 3:
                    ...
                    initChart();
                    createChart("April", indikatorALOS.April, indikatorBOR.April, indikatorBTO.April, 28);
                    break;
                case 4:
                    ...
                    initChart();
                    createChart("Mei", indikatorALOS.Mei, indikatorBOR.Mei, indikatorBTO.Mei, 28);
                    break;
                case 5:
                    ...
                    initChart();
                    createChart("Juni", indikatorALOS.Juni, indikatorBOR.Juni, indikatorBTO.Juni, 28);
                    break;
                case 6:
                    ...
                    initChart();
                    createChart("Juli", indikatorALOS.Juli, indikatorBOR.Juli, indikatorBTO.Juli, 28);
                    break;
                case 7:
                    ...
                    initChart();
                    createChart("Agustus", indikatorALOS.Agustus, indikatorBOR.Agustus, indikatorBTO.Agustus, 28);
                    break;
                case 8:
                    ...
                    initChart();
                    createChart("Oktober", indikatorALOS.Oktober, indikatorBOR.Oktober, indikatorBTO.Oktober, 28);
                    break;
                case 9:
                    ...
                    initChart();
                    createChart("November", indikatorALOS.November, indikatorBOR.November, indikatorBTO.November, 28);
                    break;
                case 10:
                    ...
                    initChart();
                    createChart("Desember", indikatorALOS.Desember, indikatorBOR.Desember, indikatorBTO.Desember, 28);
                    break;
                default:
                    break;
            }
